        ...
        <div class="container flex flex-wrap justify-between items-center mx-auto">
          ...
          <div class="flex items-center md:order-2">
            ...
            <div class="hidden py-3 px-4 md:inline-block">
              <span class="block text-sm text-gray-900 dark:text-white">Админ Админыч</span>
              <span class="block text-sm font-medium text-gray-500 truncate dark:text-gray-400">admin@mail.ru</span>
            </div>
            ...
            <div class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown">
              <ul class="py-1" aria-labelledby="dropdown">
                ...
                <li>
                  <a href="#" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Выйти</a>
                </li>
              </ul>
            </div>
